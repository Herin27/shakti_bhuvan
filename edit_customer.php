...
<body>
    ...
    <div class="container">
        <h1 class="mb-4">
            <a href="admin_dashboard.php?section=customers-section" class="text-secondary me-2"><i
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="location" name="location"
                            value="<?php echo htmlspecialchars($customer['location']); ?>">
                    </div>
                    <div class="col-md-6">
                        ...
                        <select id="status" name="status" class="form-select" required>
                            ...
                            <option value="VIP" <?php echo ($customer['status'] == 'VIP') ? 'selected' : ''; ?>>VIP
                            </option>
                        </select>
                    </div>
                </div>
            ...
            <div class="card p-4 mb-4">
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <input type="number" class="form-control" id="bookings_count" name="bookings_count"
                            value="<?php echo htmlspecialchars($customer['bookings']); ?>">
                    </div>
                    <div class="col-md-6">
                        <label for="total_spent" class="form-label">Total Spent (₹)</label>
                        <input type="number" step="0.01" class="form-control" id="total_spent" name="total_spent"
                            value="<?php echo htmlspecialchars($customer['total_spent']); ?>">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Member Since</label>
                        <input type="text" class="form-control"
                            value="<?php echo date('Y-m-d', strtotime($customer['member_since'])); ?>" disabled>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Rating</label>
                        <input type="text" class="form-control"
                            value="<?php echo htmlspecialchars($customer['rating'] ?? 'N/A'); ?>" disabled>
                    </div>
                </div>
            </div>

            <button type="submit" class="btn btn-primary btn-lg w-100"
                style="background-color: #a0522d; border-color: #a0522d;">
